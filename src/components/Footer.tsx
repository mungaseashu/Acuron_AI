        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Home", "Services", "Capabilities", "Why Us", "Contact"].map((link) => (
                <li key={link}>
                  <a
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {["Computer Vision", "Automation", "Voice & NLP", "Predictive Analytics"].map((s) => (
                <li key={s}>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="mailto:contact@acuronai.com" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  contact@acuronai.com
                </a>
              </li>
              <li>
                <a href="tel:+919552033662" className="text-sm text-muted-foreground hover:text-primary transition-colors">
                  +91 9552033662
                </a>
              </li>
            </ul>
