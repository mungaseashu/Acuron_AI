...
const HeroSection = () => {
  return (
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-72 h-72 rounded-full bg-accent/10 blur-3xl animate-float" style={{ animationDelay: "1.5s" }} />
      ...
      <div className="relative z-10 container mx-auto px-4 text-center">
        ...
        >
          We build AI solutions that work — locally, in the cloud, and everywhere in between.
        </motion.p>
        ...
        >
          ...
          <Button variant="outline-hero" size="lg" className="text-base border-[hsl(210,15%,30%)] text-[hsl(210,15%,80%)] hover:bg-primary/10 hover:text-primary hover:border-primary" asChild>
